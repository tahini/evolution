...
These scripts are not standalone scripts that can 'just' be run to get some data. They are provided to help data and paradata analyses of evolution-based survey results. They may not apply to any data, they may get outdated.
...
The [`installPackages.R`](installPackages.R) script will install the required dependencies for R scripts to run.